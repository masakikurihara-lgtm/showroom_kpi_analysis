            ...
            if account_id == "mksp":
                ...
                with col1:
                    ...
                    <div class="stMetric-container">
                        ...
                        <div class="metric-help">合計視聴会員数に対する初ルーム来訪者数の割合です。新規ファン獲得の効率を示します。</div>
                    </div>
                    """
                ...
                with col2:
                    ...
                    <div class="stMetric-container">
                        ...
                        <div class="metric-help">合計コメント人数に対する初コメント人数の割合です。新規リスナーの参加度合いを示します。</div>
                    </div>
                    """
                    st.markdown(metric_html, unsafe_allow_html=True)
                    st.markdown("---")
                ...
                with col3:
                    ...
                    <div class="stMetric-container">
                        ...
                        <div class="metric-help">合計ギフト人数に対する初ギフト人数の割合です。新規ファンの課金状況を示します。</div>
                    </div>
                    """
                    st.markdown(metric_html, unsafe_allow_html=True)
                    st.markdown("---")
